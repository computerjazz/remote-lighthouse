...
export const HEADER_TITLE_BACKGROUND_EDITING = WHITE_TRANSLUCENT
export const HEADER_ICON_EDITING_BACKGROUND = LIGHT_GREY
export const HEADER_ICON_EDITING = POMEGRANATE_ANALOGOUS


//Modal
export const ICON_SELECTED_BACKGROUND_COLOR = MID_GREY
export const TEXT_COLOR_LIGHT = LIGHT_GREY
export const MODAL_BACKGROUND_COLOR = WHITE_TRANSLUCENT
export const MENU_BACKGROUND_COLOR = WHITE_TRANSLUCENT
