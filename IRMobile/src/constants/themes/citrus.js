...
export const PRIMARY_LIGHT = '#ffb288' //buttons
export const PRIMARY_LIGHT_ANALOGOUS = '#a7a993' // header and footer
export const PRIMARY_DARK = '#f36a46'
...
export const BUTTON_ICON_COLOR = '#e2e7d3'
...
export const HEADER_ICON_COLOR = '#e2e7d3'
export const HEADER_TITLE_COLOR = '#e2e7d3'
